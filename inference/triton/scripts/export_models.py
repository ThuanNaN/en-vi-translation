...
HF_MODEL_EN_VI / HF_MODEL_VI_EN environment variables.
"""
...
MODELS: dict[str, tuple[str, str]] = {
    "translator_en_vi": ("HF_MODEL_EN_VI", "Helsinki-NLP/opus-mt-en-vi"),
    "translator_vi_en": ("HF_MODEL_VI_EN", "Helsinki-NLP/opus-mt-vi-en"),
}
